...
import com.example.android.marsrealestate.ui.util.event.EventObserver
...
fun View.showSnackbar(
    ...
    Snackbar.make(this, snackbarText, timeLength)
        .apply {
            ...
            action?.let { action -> setAction(action.textRes, action.actionListener) }
        }
        .run { show() }
}
...
fun View.setupSnackbar(
    ...
    showSnackbar(context.getString(it), timeLength, anchorView, onDismiss, action)
})
